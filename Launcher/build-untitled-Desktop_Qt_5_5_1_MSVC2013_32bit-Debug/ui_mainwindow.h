...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton->setStyleSheet(QStringLiteral("border-image: url(:/2/02.png);"));
        QIcon icon;
        ...
        pushButton_21->setGeometry(QRect(620, 410, 33, 20));
        pushButton_21->setStyleSheet(QStringLiteral("border-image: url(:/2/05.png);"));
